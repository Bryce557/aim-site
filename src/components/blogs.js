...
import { fetchBlogPosts, setBlogPost, submitResponse } from "../actions/blogActions";
            ...
            return (
                <div className="blog-style"> 
                    <div className="header-container">
                        <h1 className="acm-heavier size-xl acm-multi-color">
                            See what members are
                        </h1>
                        <div className="type-animation-container">
                            <TypeAnimation 
                                sequence={["sharing", 2000, "creating", 2000, "discovering", 2000]} 
                                cursor={false} 
                                speed={5} 
                                repeat={Infinity} 
                    ...
                    <div className="grid-container">
                        {blogPosts.map((blog) => 
                            <Card text='muted' className="grid-item" key={blog._id}>
                                ...
                                <Card.Footer>
                                    <Button size="large" className="full-width-button acm-multi-color button">Read More</Button>
                                </Card.Footer>
                            </Card>
                        )}
                    </div>
